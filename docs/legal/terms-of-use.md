...
You may not: rent, lease, lend, sell, redistribute or sublicense the app; copy it except as the App
Store permits; reverse engineer, decompile, or disassemble it except to the extent applicable law
...
**The analysis is an estimate produced by computer vision and audio processing, not an official
record and not a refereeing decision.** Its accuracy depends heavily on how the match was filmed —
camera height and angle, whether the whole floor and all four floor corners are in frame, whether the
...
## 3. Your content and other people

You keep all rights in the videos you record or import. We claim no ownership of them and do not use
them for anything other than producing the analysis you asked for (see the
[Privacy Policy](privacy-policy.md)).

You are responsible for having the right to make and use your footage. In particular you must:

- have the permission of anyone identifiable in the video — normally your opponent — and of the venue
  where you are filming, as their rules and local law require;
- not record where recording is prohibited, and not record anyone who has asked you not to;
- not use the app to record or analyse anything unlawful, harassing, or invasive of another person's
  privacy.

You are solely responsible for your footage and for any consequences of recording it.
...
The free allowance counts the analyses you have **run**, not the ones you keep: deleting an analysis
does not return an allowance. Opening the bundled demo analysis does not use one.
...
**Prices** (United States; other territories are priced by Apple's equivalent price tiers, and your
local price and currency are shown in the app before you buy):
...
- Your account is charged for renewal **within 24 hours before the end of the current period**, at
  the price of the plan you selected.
- You can **manage your subscription and turn off auto-renew** after purchase in your Apple Account
  settings: on your device, **Settings → [your name] → Subscriptions**.
- Deleting the app does **not** cancel the subscription. Cancel it in Apple Account settings.
- Cancelling stops the next renewal; it does not end the period you have already paid for, and it
  does not produce a partial refund for the remainder of that period.
- **If a free trial or introductory offer is ever offered, any unused portion of that free period is
  forfeited when you purchase a subscription**, where a free period is offered as part of the same
  subscription.
- Purchases are made through and processed by Apple. **Refunds are handled by Apple, not by us**, in
  accordance with Apple's policies; you can request one at
  [reportaproblem.apple.com](https://reportaproblem.apple.com). Except where the law requires
  otherwise, subscriptions are non-refundable from us.
- If we change the price of a subscription, Apple will notify you and, where Apple requires it, ask
  you to consent before the new price takes effect. If you do not consent, the subscription will not
  renew at the new price.
- Restoring a purchase on a new device is done with **Restore Purchases** in the app.
...
The optional analysis server described in the Privacy Policy is provided as a fallback and is not
...
**In the event of any failure of the app to conform to any applicable warranty, you may notify Apple,
and Apple will refund the purchase price of the app to you (if any). To the maximum extent permitted
by applicable law, Apple will have no other warranty obligation whatsoever with respect to the app.**

Some jurisdictions do not allow the exclusion of implied warranties, so parts of this section may not
apply to you. Nothing in these Terms limits any statutory consumer rights that cannot be limited —
including, for consumers in Canada, rights under applicable consumer protection legislation.
...
You must also comply with any applicable third-party terms when using the app (for example, your
wireless data plan's terms).

## 12. Third-party beneficiary

**Apple and Apple's subsidiaries are third-party beneficiaries of these Terms, and upon your
acceptance of them, Apple will have the right (and will be deemed to have accepted the right) to
enforce these Terms against you as a third-party beneficiary of them.**
...
We may update these Terms. The current version always lives at this URL, with the "Last updated" date
above. Material changes will be noted in the app's release notes, and continuing to use the app after
